function ClassEnabler() {
  ...
  if (chbx1.checked == false) {
    ...
    document.getElementById("Proof1_format").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof1_format").disabled = "disabled";
    document.getElementById("Proof1_courier").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof1_courier").disabled = "disabled";
    document.getElementById("Proof1_trackingNo").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof1_trackingNo").disabled = "disabled";
    document.getElementById("Proof1_comments").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof1_comments").disabled = "disabled";
  ...
  if (chbx2.checked == false) {
    ...
    document.getElementById("Proof2_format").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof2_format").disabled = "disabled";
    document.getElementById("Proof2_courier").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof2_courier").disabled = "disabled";
    document.getElementById("Proof2_trackingNo").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof2_trackingNo").disabled = "disabled";
    document.getElementById("Proof2_comments").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof2_comments").disabled = "disabled";
  ...
  if (chbx3.checked == false) {
    ...
    document.getElementById("Proof3_format").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof3_format").disabled = "disabled";
    document.getElementById("Proof3_courier").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof3_courier").disabled = "disabled";
    document.getElementById("Proof3_trackingNo").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof3_trackingNo").disabled = "disabled";
    document.getElementById("Proof3_comments").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof3_comments").disabled = "disabled";
  ...
  if (chbx4.checked == false) {
    ...
    document.getElementById("Proof4_format").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof4_format").disabled = "disabled";
    document.getElementById("Proof4_courier").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof4_courier").disabled = "disabled";
    document.getElementById("Proof4_trackingNo").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof4_trackingNo").disabled = "disabled";
    document.getElementById("Proof4_comments").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof4_comments").disabled = "disabled";
  ...
  if (chbx5.checked == false) {
    ...
    document.getElementById("Proof5_format").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof5_format").disabled = "disabled";
    document.getElementById("Proof5_courier").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof5_courier").disabled = "disabled";
    document.getElementById("Proof5_trackingNo").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof5_trackingNo").disabled = "disabled";
    document.getElementById("Proof5_comments").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof5_comments").disabled = "disabled";
  ...
  if (chbx6.checked == false) {
    ...
    document.getElementById("Proof6_format").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof6_format").disabled = "disabled";
    document.getElementById("Proof6_courier").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof6_courier").disabled = "disabled";
    document.getElementById("Proof6_trackingNo").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof6_trackingNo").disabled = "disabled";
    document.getElementById("Proof6_comments").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof6_comments").disabled = "disabled";
  ...
  if (chbx7.checked == false) {
    ...
    document.getElementById("Proof7_format").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof7_format").disabled = "disabled";
    document.getElementById("Proof7_courier").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof7_courier").disabled = "disabled";
    document.getElementById("Proof7_trackingNo").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof7_trackingNo").disabled = "disabled";
    document.getElementById("Proof7_comments").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof7_comments").disabled = "disabled";
  ...
  if (chbx8.checked == false) {
    ...
    document.getElementById("Proof8_format").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof8_format").disabled = "disabled";
    document.getElementById("Proof8_courier").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof8_courier").disabled = "disabled";
    document.getElementById("Proof8_trackingNo").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof8_trackingNo").disabled = "disabled";
    document.getElementById("Proof8_comments").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof8_comments").disabled = "disabled";
  ...
  if (chbx9.checked == false) {
    ...
    document.getElementById("Proof9_format").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof9_format").disabled = "disabled";
    document.getElementById("Proof9_courier").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof9_courier").disabled = "disabled";
    document.getElementById("Proof9_trackingNo").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof9_trackingNo").disabled = "disabled";
    document.getElementById("Proof9_comments").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof9_comments").disabled = "disabled";
  ...
  if (chbx10.checked == false) {
    ...
    document.getElementById("Proof10_format").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof10_format").disabled = "disabled";
    document.getElementById("Proof10_courier").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof10_courier").disabled = "disabled";
    document.getElementById("Proof10_trackingNo").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof10_trackingNo").disabled = "disabled";
    document.getElementById("Proof10_comments").setAttribute("style", "cursor:not-allowed");
    document.getElementById("Proof10_comments").disabled = "disabled";
